        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Predict the best crop to grow based on your soil conditions, weather data, and environmental factors using advanced AI technology
            </p>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              {prediction && (
                <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <span className="text-green-700 font-semibold text-lg">Predicted Crop</span>
                  </div>
                  ...
                  <div className="mt-4 text-sm text-gray-600">
                    <p>This crop prediction is based on your soil conditions, weather data, and environmental factors.</p>
                  </div>
                </div>
              )}
              ...
              {!prediction && !error && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 text-lg">Enter your soil and environmental data to get AI-powered crop predictions</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="mt-12 bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-6">How Crop Prediction Works</h2>
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Our machine learning model analyzes the data to predict the best crop for your conditions</p>
              </div>
              <div className="text-center">
                <div className="bg-yellow-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                  <Sun className="h-8 w-8 text-yellow-600" />
                </div>
                <h3 className="font-semibold text-gray-800 mb-2">Crop Prediction</h3>
                <p className="text-gray-600 text-sm">Get accurate crop predictions optimized for your specific farm conditions</p>
              </div>
            </div>
          </div>
        </div>
...
export default SmartHealthDiagnostics;
